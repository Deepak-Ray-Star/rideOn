...
const CarDetails = () => {
  ...
  const {cars, axios, pickupDate, setPickupDate, returnDate, setReturnDate} = useContext(AppContext)
         ...
         <motion.div 
          ...
          className='lg:col-span-2'>
           <motion.img
            ...
            src={car.image} alt="cardetails" className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md' />
           <motion.div 
            initial={{ opacity:0 }}
            animate={{ opacity:1 }}
          ...
          onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <input 
                ...
                type="date" id='pickup-date' className='border border-gray-200 px-3 py-2 rounded-lg'  
            ...
            <div className='flex flex-col gap-2'>
              ...
              <input 
                ...
                type="date" id='return-date' className='border border-gray-200 px-3 py-2 rounded-lg'  
                required min={new Date().toISOString().split('T')[0]}
              />
            </div>
