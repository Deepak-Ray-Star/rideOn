...
const ManageBookings = () => {
  ...
  return (
    <div className=' px-4 md:px-10 py-10 w-full'>
      <Title title='Manage Bookings' subTitle=' Track all customers bookings, approve or cancel requests and manage bookings status' />
             ...
             {bookings.map((booking, index)=>(
              <tr key={index} className='border-t border-gray-300 text-gray-500'>
                ...
                <td className='p-3 max-md:hidden'>
                  {new Date(booking.pickupDate).toISOString().split("T")[0]} To {booking.returnDate.split('T')[0]}  
                </td>
